...
invoice_general = sqlalchemy.table(
    ...
    sqlalchemy.Column("status", sqlalchemy.Enum(InvoiceStatus), server_default=InvoiceStatus.initial),
    sqlalchemy.Column("step_left_off", sqlalchemy.Integer, nullable=False, server_default=0),
    ...
    sqlalchemy.Column("lease_agreement_id", sqlalchemy.ForeignKey("leaseagreements"))
